                            ...
                            <ul style="display: none;">
                                <li class="submenu">
                                    ...
                                    <ul class="list-unstyled" style="display: none;">
                                        ...
                                        <li><a class="active" href="departments.php">Departments</a></li>
            ...
            <div class="content container-fluid">
                 ...
                 <div class="row">
                    ...
                    <div class="col-sm-7 col-7 text-right m-b-30">
                        <a href="#" class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#add_department"><i class="fa fa-plus"></i> Add New Department</a>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_department" title="Edit"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_department" title="Delete"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <div class="modal-body">
                        <form>
							<div class="form-group custom-mt-form-group">
								<input type="text"  />
								<label class="control-label">Department Name <span class="text-danger">*</span></label><i class="bar"></i>
							</div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content modal-md">
                    ...
                    <div class="modal-body">
                        <form>
							<div class="form-group custom-mt-form-group">
								<input type="text" value="IT Management"  />
								<label class="control-label">Department Name <span class="text-danger">*</span></label><i class="bar"></i>
							</div>
                            <div class="m-t-20 text-center">

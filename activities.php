                        ...
                        <li class="submenu">
						 ...
						 <li class="submenu">
                            ...
                            <ul style="display: none;">
                                ...
                                <li>
                                    <a class="active" href="activities.php">Activities</a>
                                </li>
                                <li>
                            ...
                            <div class="activity-box">
                                <ul class="activity-list">
                                    <li>
                                        ...
                                        <div class="activity-content">
                                            <div class="timeline-content">
                                                <a href="profile.php" class="name">Lesley Grauer</a> added new Events<a href="#">Events list</a>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity-content">
                                            <div class="timeline-content">
                                                <a href="profile.php" class="name">Jeffery Lalor</a> added <a href="profile.php" class="name">Loren Gatlin</a> and <a href="profile.php" class="name">Tarah Shropshire</a> to conduct <a href="#">Seminars</a>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity-content">
                                            <div class="timeline-content">
                                                <a href="profile.php" class="name">Catherine Manseau</a>Finished Subject<a href="#">Appointment booking with principal</a>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity-content">
                                            <div class="timeline-content">
                                                <a href="profile.php" class="name">Bernardo Galaviz</a> changed the Events name <a href="#">Events list</a>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity-content">
                                            <div class="timeline-content">
                                                <a href="profile.php" class="name">Mike Litorus</a> added new Events<a href="#">Events list</a>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity-content">
                                            <div class="timeline-content">
                                                <a href="profile.php" class="name">Jeffery Lalor</a> added <a href="profile.php" class="name">Jeffrey Warden</a> and <a href="profile.php" class="name">Bernardo Galaviz</a> to the Events.

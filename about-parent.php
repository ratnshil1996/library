                            ...
                            <ul class="notification-list">
                                <li class="notification-message">
                                    <a href="activities.php">
                                        <div class="media">
											<span class="avatar">
												<img alt="Jeffrey M. Wong" src="assets/img/user.jpg" class="img-fluid rounded-circle">
											</span>
											<div class="media-body">
												<p class="noti-details"><span class="noti-title">Jeffrey M. Wong</span> is now following you </p>
                                ...
                                <li class="notification-message">
                                    <a href="activities.php">
                                        <div class="media">
											...
											<div class="media-body">
												<p class="noti-details"><span class="noti-title">Michael S. Porch</span> sent you a message.</p>
                                ...
                                <li class="notification-message">
                                    <a href="activities.php">
                                        <div class="media">
											...
											<div class="media-body">
												<p class="noti-details"><span class="noti-title">Elaine A. Keenum</span> like your photo.</p>
                                ...
                                <li class="notification-message">
                                    <a href="activities.php">
                                        <div class="media">
											<span class="avatar">M</span>
											<div class="media-body">
												<p class="noti-details"><span class="noti-title">Marion S. Shannon</span> booking appoinment for meeting.</p>
                                ...
                                <li class="notification-message">
                                    <a href="activities.php">
                                        <div class="media">
											<span class="avatar">E</span>
											<div class="media-body">
												<p class="noti-details"><span class="noti-title">Erin A. Collins</span> like your photo.</p>
                    ...
                    <ul>
						...
						<li class="submenu">
                            ...
                            <ul class="list-unstyled" style="display: none;">
								...
								<li><a class="active" href="about-parent.php">About Parent</a></li>
                            </ul>
                        </li>
						<li class="submenu">
									...
									<div class="col-lg-3 col-md-12 col-sm-12 col-12">
													...
													<div class="row">
														<div class="col-lg-12 col-md-12 col-sm-12 col-12">
															...
															<div class="aboutprofile-name">
																<h5 class="text-center mt-2">Jeffrey M. Wong</h5>
																<p class="text-center">Mathematical technician</p>
															</div>
										...
										<div class="aboutme-profile mt-4">
											<div class="card">
												...
												<div class="card-body">
													<p>Hello I am Jeffrey M. Wong Mathematical technician, Parent of Parker 1-B.</p>
													<ul class="list-group list-group-flush">
														<li class="list-group-item"><b>Gender</b><a href="#" class="float-right">Male</a></li>
														<li class="list-group-item"><b>Student Name</b><a href="#" class="float-right">Parker</a></li>
																...
																<div id="biography" class="biography">
																	<div class="row">
																		<div class="col-md-3 col-6"> <strong>Full Name</strong>
																			<br>
																			<p class="text-muted">Jeffrey M. Wong</p>
																		</div>
																		...
																		<div class="col-md-3 col-6"> <strong>Email</strong>
																			<br>
																			<p class="text-muted">jeffreymwong@example.com</p>
																		</div>

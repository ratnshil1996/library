            ...
            <div class="sidebar-inner slimscroll">
                <div class="sidebar-menu">
                    <ul>
                        ...
                        <li class="menu-title"><a href="compose.php" class="btn btn-primary btn-block mt-1">Compose</a></li>
                        <li class="active">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 col-md-4 col-4 top-action-right">
                                        <div class="text-right">
                                            ...
                                            <div class="btn-group">
                                                <a class="btn btn-white text-white"><i class="fa fa-angle-left"></i></a>
                                                <a class="btn btn-white text-white"><i class="fa fa-angle-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>

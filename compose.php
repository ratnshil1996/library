        ...
        <div class="sidebar" id="sidebar"> <!-- sidebar -->
            <div class="sidebar-inner slimscroll">
                <div class="sidebar-menu">
                    <ul>
                        <li>
                            <a href="inbox.php"><i class="fa fa-home back-icon"></i> Back to Inbox</a>
                        </li>
                        <li>
                            ...
                            <form>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group custom-mt-form-group">
                                            <input type="text"  />
											<label class="control-label">Cc</label><i class="bar"></i>
                                        </div>
                                    </div>
                                    <div class="col-md-6 custom-mt-form-group ">
                                        <div class="form-group">
											<input type="text"  />
											<label class="control-label pl-3">Bcc</label><i class="bar"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group custom-mt-form-group">
									<input type="text"  />
									<label class="control-label w-100">Subject</label><i class="bar"></i>
                                </div>
                                <div class="form-group custom-mt-form-group">
                                   <input type="text" class="form-control summernote" placeholder="Enter your message here"> 
                                </div>

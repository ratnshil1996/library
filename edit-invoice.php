			...
			<div class="page-header">
					<div class="row">
						<div class="col-lg-7 col-md-12 col-sm-12 col-12">
							<h5 class="text-uppercase">Edit Invoice</h5>
						</div>
						<div class="col-lg-5 col-md-12 col-sm-12 col-12">
							<ul class="list-inline breadcrumb float-right">
								<li class="list-inline-item"><a href="index.php">Home</a></li>
								<li class="list-inline-item"><a href="index.php">Accounts</a></li>
								<li class="list-inline-item">Edit Invoice</li>
							</ul>
						</div>
					</div>
				</div>
                    ...
                    <div class="col-sm-12">
                        <form>
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="form-group custom-mt-form-group mt-4">
										<input type="text" value="barrycuda@example.com"/>
                                ...
                                <div class="col-sm-6 col-md-3">
									<div class="form-group">
										<textarea id="message" class="form__field" placeholder="Teacher Address" rows="4">5754 Airport Rd, Coosada, AL, 36020</textarea>
										<label for="message" class="form-label">Teacher Address</label>
									</div>
                                </div>
                                <div class="col-sm-6 col-md-3">
									<div class="form-group">
										<textarea id="message" class="form__field" placeholder="Billing Address" rows="4">5754 Airport Rd, Coosada, AL, 36020</textarea>
										<label for="message" class="form-label">Billing Address</label>
									</div>
                                </div>
                                <div class="col-sm-6 col-md-3">
									<div class="form-group custom-mt-form-group">
										 <input value="2018/09/20" class="datetimepicker" type="text"> 
                                ...
                                <div class="col-sm-6 col-md-3">
									...
									<div class="form-group custom-mt-form-group">
										 <input value="2018/09/27" class="datetimepicker" type="text"> 
                                        ...
                                        <table class="table table-hover table-white">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td>
                                                        <input class="form-control" value="Vehicle Module" type="text" style="min-width:150px">
                                                    </td>
                                                    <td>
                                                        <input class="form-control" value="Create, edit delete functionlity" type="text" style="min-width:150px">
                                                    </td>
                                                    <td>
                                                        <input class="form-control" style="width:100px" value="112" type="text">
                                                    </td>
                                                    <td>
                                                        <input class="form-control" style="width:80px" value="1" type="text">
                                                    </td>
                                                    <td>
                            ...
                            <div class="text-center m-t-20">
                                <button class="btn btn-primary btn-lg">Save Invoice</button>
                            </div>
                        </form>
                    </div>
                </div>

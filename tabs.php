        ...
        <div class="page-wrapper"> <!-- content -->
            <div class="content container-fluid">
					...
					<div class="row">
						...
						<div class="col-lg-5 col-md-12 col-sm-12 col-12">
							<ul class="list-inline breadcrumb float-right">
								...
								<li class="list-inline-item">Tabs</li>
							</ul>
						</div>
					</div>
				</div>        
                <div class="row">
                    <div class="col-md-6">
                        <div class="card-box">
                            <h4 class="card-title">Basic tabs</h4><br>
                    ...
                    <div class="col-md-6">
                        <div class="card-box">
                            <h4 class="card-title">Basic justified tabs</h4><br>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card-box">
                            <h4 class="card-title">Top line tabs</h4><br>
                    ...
                    <div class="col-md-6">
                        <div class="card-box">
                            <h4 class="card-title">Top line justified</h4><br>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card-box">
                            <h6 class="card-title">Bottom line tabs</h6><br>
                    ...
                    <div class="col-md-6">
                        <div class="card-box">
                            <h6 class="card-title">Bottom line justified</h6><br>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card-box">
                            <h4 class="card-title">Solid tabs</h4><br>
                    ...
                    <div class="col-md-6">
                        <div class="card-box">
                            <h4 class="card-title">Solid justified</h4><br>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card-box">
                            <h4 class="card-title">Solid Rounded</h4><br>
                    ...
                    <div class="col-md-6">
                        <div class="card-box">
                            <h4 class="card-title">Rounded justified</h4><br>

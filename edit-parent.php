                    ...
                    <ul>
						...
						<li class="submenu">
                            ...
                            <ul class="list-unstyled" style="display: none;">
                                ...
                                <li><a class="active" href="edit-parent.php">Edit Parent</a></li>
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-6 col-12">
											  <form>
												...
												<div class="form-group custom-mt-form-group">
													<input type="text" value="Jyou@example.com "  />
												...
												<div class="form-group custom-mt-form-group">
													 <input class="datetimepicker" value="12/04/1987" type="text"> 
										...
										<div class="col-lg-6 col-md-6 col-sm-6 col-12">
											<form>
												...
												<div class="form-group custom-mt-form-group">
													<input type="text" value="Richiy John"  >
												...
												<div class="form-group custom-mt-form-group">
													<input type="number" value="973-584-5870"  />
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-12">
											<form>
												<div class="form-group">
													<textarea id="message" class="form__field" placeholder="Address" rows="4"></textarea>

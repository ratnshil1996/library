			...
			<div class="page-header">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-parent.php" class="btn btn-primary float-right btn-rounded"><i class="fa fa-plus"></i> Add Parent</a>
                        <div class="view-icons">
                            <a href="all-parents.php" class="grid-view btn btn-link"><i class="fa fa-th"></i></a>
                            <a href="parents-list.php" class="list-view btn btn-link active"><i class="fa fa-bars"></i></a>
                        </div>
                    </div>
                </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <h2><a href="profile.php">Jeffrey M. Wong <span></span></a></h2>
                                        </td>
                                        <td>PT-0d001</td>
                                        <td>Male</td>
                                        <td>Parker</td>
                                        ...
                                        <td>jeffreymwong@example.com</td>
                                        <td>973-584-5870</td>
                                       <td class="text-right" >
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <h2><a href="profile.php">Michael S. Porch<span></span></a></h2>
                                        </td>
                                        <td>PT-0d002</td>
                                        <td>Male</td>
                                        <td> Smith</td>
                                        ...
                                        <td>michaelsporch@example.com</td>
                                        <td>804-478-7698</td>
                                        <td class="text-right" >
											<a href="edit-exam.php" class="btn btn-primary btn-sm mb-1">
												<i class="fa fa-pencil" aria-hidden="true"></i>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <h2><a href="profile.php">Elaine A. Keenum<span></span></a></h2>
                                        </td>
                                        <td>PT-0d003</td>
                                        <td>Male</td>
                                        <td>Hensley</td>
                                        ...
                                        <td>elaineakeenum@example.com</td>
                                        <td>217-509-0538</td>
                                        <td class="text-right" >
											<a href="edit-exam.php" class="btn btn-primary btn-sm mb-1">
												<i class="fa fa-pencil" aria-hidden="true"></i>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="profile.php" class="avatar">M</a>
                                            <h2><a href="profile.php">Marion S. Shannon<span></span></a></h2>
                                        </td>
                                        <td>PT-0d004</td>
                                        <td>Male</td>
                                        <td>Parker</td>
                                        ...
                                        <td>marionsshannon@example.com</td>
                                        <td>972-874-9653</td>
                                        <td class="text-right" >
											<a href="edit-exam.php" class="btn btn-primary btn-sm mb-1">
												<i class="fa fa-pencil" aria-hidden="true"></i>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="profile.php" class="avatar">E</a>
                                            <h2><a href="profile.php">Erin A. Collins<span></span></a></h2>
                                        </td>
                                        <td>PT-0d005</td>
                                        <td>Male</td>
                                        <td>Jackson</td>
                                        ...
                                        <td>erinacollins@example.com</td>
                                        <td>315-224-9840</td>
                                        <td class="text-right" >
											<a href="edit-exam.php" class="btn btn-primary btn-sm mb-1">
												<i class="fa fa-pencil" aria-hidden="true"></i>
                                   ...
                                   <tr>
                                        <td>
                                            ...
                                            <h2><a href="profile.php">William D. Jones<span></span></a></h2>
                                        </td>
                                        <td>PT-0d006</td>
                                        <td>Male</td>
                                        <td>Mason</td>
                                        ...
                                        <td>williamdjones@example.com</td>
                                        <td>973-584-58700</td>
                                        <td class="text-right" >
											<a href="edit-exam.php" class="btn btn-primary btn-sm mb-1">
												<i class="fa fa-pencil" aria-hidden="true"></i>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="profile.php" class="avatar">J</a>
                                            <h2><a href="profile.php">Jennifer M. Walker<span></span></a></h2>
                                        </td>
                                        <td>PT-0d006</td>
                                        <td>Male</td>
                                        <td>Garrett</td>
                                        ...
                                        <td>JenniferMWalker@jourrapide.com</td>
                                        <td>972-372-5354</td>
                                        <td class="text-right" >
											<a href="edit-exam.php" class="btn btn-primary btn-sm mb-1">
												<i class="fa fa-pencil" aria-hidden="true"></i>
									 ...
									 <tr>
                                        <td>
                                            ...
                                            <h2><a href="profile.php">Christopher S. Ramirez<span></span></a></h2>
                                        </td>
                                        <td>PT-0d007</td>
                                        <td>Male</td>
                                        <td>Perry</td>
                                        ...
                                        <td>Christophersramirez@@example.com</td>
                                        <td>734-459-5639</td>
                                        <td class="text-right" >
											<a href="edit-exam.php" class="btn btn-primary btn-sm mb-1">
												<i class="fa fa-pencil" aria-hidden="true"></i>
									  ...
									  <tr>
                                        <td>
                                            ...
                                            <h2><a href="profile.php">Danielle D. Hickson<span></span></a></h2>
                                        </td>
                                        <td>PT-0d008</td>
                                        <td>Male</td>
                                        <td>Williams</td>
									 ...
									 <tr>
                                        <td>
                                            <a href="profile.php" class="avatar">J</a>
                                            <h2><a href="profile.php">Jacqueline C. Green<span></span></a></h2>
                                        </td>
                                        <td>PT-0d010</td>
                                        <td>Male</td>
                                        <td>Kulick</td>
                                        ...
                                        <td>jacquelinecgreen@example.com</td>
                                        <td>304-370-7153</td>
                                        <td class="text-right" >
											<a href="edit-exam.php" class="btn btn-primary btn-sm mb-1">
												<i class="fa fa-pencil" aria-hidden="true"></i>

        ...
        <div class="page-wrapper"> <!-- content -->
			...
			<div class="page-header">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box">
                            <h4 class="payslip-title"><b>Payslip for the month of September 2018</b></h4>
                            <div class="row">
                                ...
                                <div class="col-sm-6 m-b-20">
                                    <div class="invoice-details">
                                        ...
                                        <ul class="list-unstyled">
                                            <li>Salary Month: <span>September, 2018</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 m-b-20">
                                    <ul class="list-unstyled">
                                        <li>
                                            <h5 class="m-b-0"><strong>John Doe</strong></h5></li>
                                        <li><span> Maths Teacher</span></li>

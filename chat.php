                                ...
                                <div class="navbar">
                                    <div class="user-details mr-auto">
                                        ...
                                        <div class="user-info float-left">
                                            <a href="profile.php" title="Mike Litorus"><span class="font-bold">Mike Litorus</span> <i class="typing-text">Typing...</i></a>
                                    ...
                                    <ul class="nav custom-menu">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="voice-call.php"><i class="fa fa-phone" aria-hidden="true"></i></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="video-call.php"><i class="fa fa-video-camera" aria-hidden="true"></i></a>
                                        </li>

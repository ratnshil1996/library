...
<body>
	<div class="main-wrapper">
				...
				<div class="content-page">
                   <div class="row">
                    ...
                    <div class="col-sm-4 col-6 text-right m-b-30">
                        <a href="#" class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#add_tax"><i class="fa fa-plus"></i> Add Tax</a>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_tax" title="Edit"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_tax" title="Delete"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-group custom-mt-form-group">
								<input type="text"  />
								<label class="control-label w-100">Tax Name <span class="text-danger">*</span></label><i class="bar"></i>
                            </div>
                            <div class="form-group custom-mt-form-group">
								<input type="text"  />
								<label class="control-label w-100">Tax Percentage (%) <span class="text-danger">*</span></label><i class="bar"></i>
                            </div>
                            <div class="form-group custom-mt-form-group">
								<select >
								 ...
								 <label class="control-label">status <span class="text-danger">*</span></label><i class="bar"></i>
                            </div>
        ...
        <div id="delete_tax" class="modal" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content modal-md">
                    <div class="modal-header">

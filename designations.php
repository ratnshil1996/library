                            ...
                            <ul style="display: none;">
                                <li class="submenu">
                                    ...
                                    <ul class="list-unstyled" style="display: none;">
                                        ...
                                        <li><a class="active" href="designations.php">Designations</a></li>
                                    </ul>
                                </li>
                                <li>
				...
				<div class="page-header">
					<div class="row">
						<div class="col-lg-7 col-md-12 col-sm-12 col-12">
							<h5 class="text-uppercase">designations</h5>
						</div>
						<div class="col-lg-5 col-md-12 col-sm-12 col-12">
							<ul class="list-inline breadcrumb float-right">
								...
								<li class="list-inline-item"> Designations</li>
							</ul>
						</div>
					</div>
				</div>
				<div class="content-page">
                 <div class="row">
                    ...
                    <div class="col-sm-7 col-7 text-right m-b-30">
                        <a href="#" class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#add_designation"><i class="fa fa-plus"></i> Add New Designation</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_designation" title="Edit"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_designation" title="Delete"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <div class="modal-body">
                        <form>
                           <div class="form-group custom-mt-form-group">
								<input type="text"  />
								<label class="control-label">Designation Name <span class="text-danger">*</span></label><i class="bar"></i>
							</div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content modal-md">
                    ...
                    <div class="modal-body">
                        <form>
							<div class="form-group custom-mt-form-group">
								<input type="text" value="Science Teacher"  />
								<label class="control-label">Designation Name <span class="text-danger">*</span></label><i class="bar"></i>
							</div>

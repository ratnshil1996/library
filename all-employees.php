                    ...
                    <ul>
						...
						<li class="submenu">
                            ...
                            <ul class="list-unstyled" style="display: none;">
								...
								<li><a href="about-parent.php">Edit Parent</a></li>
                            </ul>
                        </li>
						<li class="submenu">
						 ...
						 <li class="submenu">
                            ...
                            <ul style="display: none;">
                                <li class="submenu">
                                    ...
                                    <ul class="list-unstyled" style="display: none;">
										<li class="active" ><a href="all-employees.php">All Employees</a></li>
            ...
            <div class="content container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-employee.php" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Employees</a>
                ...
                <div class="row staff-grid-row">
                    ...
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            ...
                            <div class="small text-muted">Library</div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">

                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled" style="display: none;">
                                ...
                                <li><a class="active" href="typography.php">Typography</a></li>
			...
			<div class="page-header">
				<div class="row">
					<div class="col-lg-7 col-md-12 col-sm-12 col-12">
						<h5 class="text-uppercase">Typography</h5>
					</div>
					<div class="col-lg-5 col-md-12 col-sm-12 col-12">
						<ul class="list-inline breadcrumb float-right">
							<li class="list-inline-item"><a href="#">Home</a></li>
							<li class="list-inline-item"><a href="#">Components</a></li>
							<li class="list-inline-item">Typography</li>
						</ul>
					</div>
				</div>
			</div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box">
                            <h4 class="card-title">Headings</h4><br>
                        ...
                        <div class="card-box">
                            <h4 class="card-title">Blockquotes</h4><br>
                            <blockquote>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box">
                            <h4 class="card-title">Text elements</h4><br>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card-box">
                            <h4 class="card-title">Bullet Lists</h4><br>
                            <ul>
                    ...
                    <div class="col-md-4">
                        <div class="card-box">
                            <h4 class="card-title">Unstyled Lists</h4><br>

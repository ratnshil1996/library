                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
						...
						<li class="submenu">
                            ...
                            <ul class="list-unstyled" style="display: none;">
                                <li><a class="active" href="all-students.php">All Students</a></li>
					...
					<div class="row">
						...
						<div class="col-lg-5 col-md-12 col-sm-12 col-12">
							<ul class="list-inline breadcrumb float-right">
								...
								<li class="list-inline-item"><a href="index.php">Students</a></li>
                ...
                <div class="row staff-grid-row">
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            ...
                            <div class="dropdown profile-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="edit-student.php"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_employee"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                </div>
                            </div>
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="student-profile.php">Ruth C. Gault</a></h4>
                    ...
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="student-profile.php">Michael V. Buttars</a></h4>
                    ...
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="student-profile.php">John Smith</a></h4>
                    ...
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="student-profile.php">Mike Litorus</a></h4>
                    ...
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="student-profile.php">Wilmer Deluna</a></h4>
                    ...
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="student-profile.php">Jeffrey Warden</a></h4>
                    ...
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            <div class="profile-img">
                                <a href="student-profile.php" class="avatar">B</a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="student-profile.php">Bernardo Galaviz</a></h4>
                    ...
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="student-profile.php">Lesley Grauer</a></h4>
                            <div class="small text-muted">3 std B</div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="student-profile.php">Jeffery Lalor</a></h4>
                            <div class="small text-muted">3 std B</div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="student-profile.php">Loren Gatlin</a></h4>
                            <div class="small text-muted">3 std B</div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="student-profile.php">Tarah Shropshire</a></h4>
                    ...
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="student-profile.php">Catherine Manseau</a></h4>
                            <div class="small text-muted">1 std B</div>
                        </div>
                    </div>
                </div>

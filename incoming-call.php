...
<body>
    <div class="main-wrapper">
                                                                    ...
                                                                    <li>
                                                                        <div class="files-cont">
                                                                            ...
                                                                            <div class="files-info">
                                                                                <span class="file-name text-ellipsis">School Annual day.xls</span>
	 ...
	 <div id="incoming_call" class="modal" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="profile-widget">
                        <div class="profile-img">
                            <a href="my-profile.php" class="avatar"><img src="assets/img/user-03.jpg" alt=""></a>
                        </div>
                        <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="my-profile.php">Tressa Wexler</a></h4>
                        <div class="small text-muted">calling ...</div>
                        <div class="incoming-btns">
                            <a href="chat.php" class="btn btn-success m-r-10">Decline</a>
                            <a href="voice-call.php" class="btn btn-danger">Answer</a>
                        </div>
                    </div>
                </div>
            </div>

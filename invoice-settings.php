                 ...
                 <div class="page-header">
					<div class="row">
						<div class="col-lg-7 col-md-12 col-sm-12 col-12">
							<h5 class="text-uppercase">Invoice Settings</h5>
						</div>
						<div class="col-lg-5 col-md-12 col-sm-12 col-12">
							<ul class="list-inline breadcrumb float-right">
								<li class="list-inline-item"><a href="#">Home</a></li>
								<li class="list-inline-item"><a href="#">Settings</a></li>
								<li class="list-inline-item"> Invoice Settings</li>
							</ul>
						</div>
					</div>
				</div>
                    ...
                    <div class="col-md-8 offset-md-2">
                        <form>
							...
							<div class="form-group custom-mt-form-group">
								<input name="website_name" value="INV" >
								<label class="control-label">Invoice prefix</label><i class="bar"></i>
							</div>
							<div class="form-group custom-mt-form-group">
								<div class="row">
									<div class="col-lg-10 col-md-10 col-10">
										<input name="website_name" type="file" style="margin-bottom:10px;">
										<label class="control-label pl-3">Light Logo</label><i class="bar"></i>
							...
							<div class="form-group custom-mt-form-group">
								<div class="row">
									<div class="col-lg-10 col-md-10 col-9">
										<input name="website_name" type="file" style="margin-bottom:10px;">
										<label class="control-label pl-3">Invoice Logo</label><i class="bar"></i>
										<span class="form-text text-muted">Recommended image size is 200px x 40px</span>
									</div>
									 <div class="col-lg-2 col-md-2 col-3">
										<div class="img-thumbnail float-right" style="max-width:none;"><img src="assets/img/logo.png" alt="" width="100" height="100"></div>
									</div>
								</div>
							</div>

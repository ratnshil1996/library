			...
			<div class="page-header">
					<div class="row">
						<div class="col-lg-7 col-md-12 col-sm-12 col-12">
							<h5 class="text-uppercase">Salary Settings</h5>
						</div>
						<div class="col-lg-5 col-md-12 col-sm-12 col-12">
							<ul class="list-inline breadcrumb float-right">
								<li class="list-inline-item"><a href="#">Home</a></li>
								<li class="list-inline-item"><a href="#">Settings</a></li>
								<li class="list-inline-item">Salary Settings</li>
							</ul>
						</div>
					</div>
				</div>
                        ...
                        <form>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
									<div class="form-group custom-mt-form-group">
										<input >
										<label class="control-label">DA (%)</label><i class="bar"></i>
									</div>
                                </div>
                                <div class="col-sm-6">
									<div class="form-group custom-mt-form-group">
										<input >
										<label class="control-label">HRA (%)</label><i class="bar"></i>
									</div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
									<div class="form-group custom-mt-form-group">
										<input >
										<label class="control-label">Employee Share (%)</label><i class="bar"></i>
									</div>
                                </div>
                                <div class="col-sm-6">
									<div class="form-group custom-mt-form-group">
										<input >
										<label class="control-label">Organization Share (%)</label><i class="bar"></i>
									</div>
                                </div>
                            </div>

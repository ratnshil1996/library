						 ...
						 <li class="submenu">
                            ...
                            <ul style="display: none;">
                                <li class="submenu">
                                    ...
                                    <ul class="list-unstyled" style="display: none;">
										<li><a class="active" href="all-employees.php">All Employees</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        ...
                        <div class="view-icons">
                            <a href="all-employees.php" class="grid-view btn btn-link"><i class="fa fa-th"></i></a>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <h2><a href="profile.php">Ruth C. Gault <span>Maths Teacher</span></a></h2>
                                        </td>
                                        <td>EM-0001</td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <h2><a href="profile.php">Richard Miles <span>English</span></a></h2>
                                        </td>
                                        <td>EM-0002</td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <h2><a href="profile.php">Mike Litorus <span>Library</span></a></h2>
                                        </td>
                                        <td>EM-0004</td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <h2><a href="profile.php">Wilmer Deluna <span>Science Teacher</span></a></h2>
                                        </td>
                                        <td>EM-0005</td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="profile.php" class="avatar">J</a>
                                            <h2><a href="profile.php">Jeffrey Warden <span>Sports</span></a></h2>
                                        </td>
                                        <td>EM-0006</td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <h2><a href="profile.php">Bernardo Galaviz <span>English</span></a></h2>
                                        </td>
                                        <td>EM-0007</td>

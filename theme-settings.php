			...
			<div class="page-header">
					<div class="row">
						<div class="col-lg-7 col-md-12 col-sm-12 col-12">
							<h5 class="text-uppercase">Theme Settings</h5>
						</div>
						<div class="col-lg-5 col-md-12 col-sm-12 col-12">
							<ul class="list-inline breadcrumb float-right">
								<li class="list-inline-item"><a href="#">Home</a></li>
								<li class="list-inline-item"><a href="#">Settings</a></li>
								<li class="list-inline-item">Theme Settings</li>
							</ul>
						</div>
					</div>
				</div>
                        ...
                        <form>
                            <h4 class="page-title">Theme Settings</h4>
								<div class="form-group custom-mt-form-group">
									<input name="website_name" value="School-admin">
									<label class="control-label">Website Name</label><i class="bar"></i>
								</div>
								<div class="form-group custom-mt-form-group">
									<div class="row">
								...
								<div class="form-group custom-mt-form-group">
									<div class="row">
										<div class="col-lg-10 col-md-10 col-9">
											<input name="website_name" type="file" style="margin-bottom:10px;">
											<label class="control-label pl-3">Favicon</label><i class="bar"></i>

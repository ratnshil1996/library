				...
				<div class="page-header">
					<div class="row">
						<div class="col-lg-7 col-md-12 col-sm-12 col-12">
							<h5 class="text-uppercase">Edit Employee</h5>
						</div>
									...
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-6 col-12">
											<form>
												...
												<div class="form-group custom-mt-form-group">
													<input type="text" class="datetimepicker"  value="1845-02-04"  />
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-12">
											<form>
												<div class="form-group">
													<textarea id="message" class="form__field" placeholder="Premanent Address" rows="4">14,Ganthi street, New Delhi</textarea>

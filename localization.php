            ...
            <div class="sidebar-inner slimscroll">
                <div class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="settings.php">School Settings</a>
                        </li>
                        <li class="active">
			...
			<div class="page-header">
					<div class="row">
						<div class="col-lg-7 col-md-12 col-sm-12 col-12">
							<h5 class="text-uppercase">Basic settings</h5>
						</div>
						<div class="col-lg-5 col-md-12 col-sm-12 col-12">
							<ul class="list-inline breadcrumb float-right">
								<li class="list-inline-item"><a href="#">Home</a></li>
								<li class="list-inline-item"><a href="#">Settings</a></li>
								<li class="list-inline-item"> Localization</li>
							</ul>
						</div>
					</div>
				</div>
                ...
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        <form>
						<h4 class="text-uppercase">Basic settings</h4>
                            <div class="row">
                                <div class="col-sm-6">
									<div class="form-group custom-mt-form-group">
										<select >
										 ...
										 <label class="control-label">Default Country</label><i class="bar"></i>
									</div>
                                </div>
                                <div class="col-sm-6">
									<div class="form-group custom-mt-form-group">
										<select >
                                            ...
                                            <option value="Y/m/d">2018/05/15</option>
                                            <option value="Y-m-d">2018-05-15</option>
                                            <option value="M d Y">May 15 2018</option>
                                            <option selected="selected" value="d M Y">15 May 2018</option>
										</select>
										 <label class="control-label">Date Format</label><i class="bar"></i>
									</div>
                                </div>
                                <div class="col-sm-6">
									<div class="form-group custom-mt-form-group">
                                ...
                                <div class="col-sm-6">
									<div class="form-group custom-mt-form-group">
										<select >
										 ...
										 <label class="control-label">Default Language</label><i class="bar"></i>
									</div>
                                </div>
                                <div class="col-sm-6">
									<div class="form-group custom-mt-form-group">
										<select >
										 ...
										 <label class="control-label">Currency Code</label><i class="bar"></i>
									</div>
                                </div>
                                <div class="col-sm-6">
									<div class="form-group custom-mt-form-group">
										<input  value="$" >
										<label class="control-label">Currency Symbol</label><i class="bar"></i>
									</div>
                                </div>

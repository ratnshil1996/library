                                    ...
                                    <a href="activities.php">
                                        <div class="media">
											...
											<div class="media-body">
												<p class="noti-details"><span class="noti-title">John Doe</span> added new Events<span class="noti-title">Patient appointment booking</span></p>
                                ...
                                <li class="notification-message">
                                    <a href="activities.php">
                                        <div class="media">
											...
											<div class="media-body">
												<p class="noti-details"><span class="noti-title">Tarah Shropshire</span> changed the Events name <span class="noti-title">Appointment booking with pricipal</span></p>
                                ...
                                <li class="notification-message">
                                    <a href="activities.php">
                                        <div class="media">
											...
											<div class="media-body">
												<p class="noti-details"><span class="noti-title">Misty Tison</span> added <span class="noti-title">Domenic Houston</span> and <span class="noti-title">Claire Mapes</span> to project <span class="noti-title">Events list</span></p>
                                ...
                                <li class="notification-message">
                                    <a href="activities.php">
                                        <div class="media">
											...
											<div class="media-body">
												<p class="noti-details"><span class="noti-title">Rolland Webber</span>Finished Subject<span class="noti-title">Events list</span></p>
                                ...
                                <li class="notification-message">
                                    <a href="activities.php">
                                        <div class="media">
											<span class="avatar">T</span>
											<div class="media-body">
												<p class="noti-details"><span class="noti-title">Bernardo Galaviz</span> added new Events<span class="noti-title">Private chat module</span></p>
        ...
        <div class="sidebar" id="sidebar"> <!-- sidebar -->
            <div class="sidebar-inner slimscroll">
                <div class="sidebar-menu">
                    <ul>
                        <li>
                            <a href="index.php"><i class="fa fa-home back-icon"></i> Back to Home</a>
                        </li>
                                                ...
                                                <div class="message-inner">
                                                    ...
                                                    <div class="message-area">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" placeholder="Type message..."></input>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form>
								...
								<div class="form-group custom-mt-form-group">
									<input type="text"  />
									<label class="control-label">Send invites to: <span class="text-muted-light">(optional)</span></label><i class="bar"></i>
								</div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
							...
							<div class="form-group custom-mt-form-group">
								<input type="text"  />
								<label class="control-label">Share With</label><i class="bar"></i>
							</div>
                            <div class="m-t-50 text-center">

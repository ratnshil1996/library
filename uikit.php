                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled" style="display: none;">
                                <li><a class="active" href="uikit.php">UI Kit</a></li>
			...
			<div class="page-header">
					<div class="row">
						<div class="col-lg-7 col-md-12 col-sm-12 col-12">
							<h5 class="text-uppercase">UI Kit</h5>
						</div>
						<div class="col-lg-5 col-md-12 col-sm-12 col-12">
							<ul class="list-inline breadcrumb float-right">
								<li class="list-inline-item"><a href="#">Home</a></li>
								<li class="list-inline-item"><a href="#">Components</a></li>
								<li class="list-inline-item">UI Kit</li>
							</ul>
						</div>
					</div>
				</div>
                 <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card-box">
                            <h4 class="card-title">Default Button</h4><br>
                            ...
                            <p>
								...
								<button type="button" class="btn btn-secondary btn-lg mb-1">Secondary</button>
                            ...
                            <p>
								...
								<button type="button" class="btn btn-secondary btn-sm mb-1">Secondary</button>
						...
						<div class="col-lg-12 col-12">
                        <div class="card-box">
                            <h4 class="card-title mb-1">Alerts</h4><br>
                        ...
                        <div class="card-box progress-example">
                            <h4 class="card-title">Progress Bars</h4><br>
                            <h5 class="text-muted">Large Progress Bars</h5><br>
                            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-12">
                                <div class="card-box pagination-box">
                                    <h4 class="card-title">Pagination</h4><br>
									<div>
										<ul class="pagination">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="card-box">
                                    <h4 class="card-title">Breadcrumbs</h4><br>

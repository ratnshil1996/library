                    ...
                    <ul>
						...
						<li class="submenu">
                            ...
                            <ul class="list-unstyled" style="display: none;">
								...
								<li><a class="active" href="about-student.php">About Student</a></li>
                            </ul>
                        </li>
						<li class="submenu">
                ...
                <div class="page-header">
					<div class="row">
						<div class="col-lg-7 col-md-12 col-sm-12 col-12">
							<h5 class="text-uppercase">About Student</h5>
						</div>
						<div class="col-lg-5 col-md-12 col-sm-12 col-12">
							<ul class="list-inline breadcrumb float-right">
								<li class="list-inline-item"><a href="index.php">Home</a></li>
								<li class="list-inline-item"><a href="index.php">Student</a></li>
								<li class="list-inline-item"> About Student</li>
							</ul>
						</div>
					</div>
				</div>
																...
																<div id="biography" class="biography">
																	<div class="row">
																		...
																		<div class="col-md-3 col-6"> <strong>Email</strong>
																			<br>
																			<p class="text-muted">Parker@example.com</p>
																		</div>

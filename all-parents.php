            ...
            <ul class="nav user-menu float-right">
                ...
                <li class="nav-item dropdown has-arrow">
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="parent-profile.php">My Profile</a>
                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
						...
						<li class="submenu">
                            ...
                            <ul class="list-unstyled" style="display: none;">
                                <li><a class="active" href="all-parents.php">All Parents</a></li>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled" style="display: none;">
                                ...
                                <li><a href="parent-profile.php"> Profile </a></li>
            ...
            <div class="content container-fluid">
				<div class="page-header">
					<div class="row">
						<div class="col-lg-7 col-md-12 col-sm-12 col-12">
							<h5 class="text-uppercase">all Parents</h5>
						</div>
						<div class="col-lg-5 col-md-12 col-sm-12 col-12">
							<ul class="list-inline breadcrumb float-right">
								<li class="list-inline-item"><a href="index.php">Home</a></li>
								<li class="list-inline-item"><a href="index.php">Parents</a></li>
								<li class="list-inline-item"> All Parents</li>
							</ul>
						</div>
					</div>
				</div>
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-parent.php" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Parents</a>
                        <div class="view-icons">
                            <a href="all-parents.php" class="grid-view btn btn-link active"><i class="fa fa-th"></i></a>
                            <a href="parents-list.php" class="list-view btn btn-link"><i class="fa fa-bars"></i></a>
                        </div>
                    </div>
                </div>
			<div class="content-page">
                ...
                <div class="row staff-grid-row">
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            <div class="profile-img">
                                <a href="parent-profile.php"><img class="avatar" src="assets/img/user.jpg" alt=""></a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="edit-parent.php"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_employee"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                </div>
                            </div>
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="parent-profile.php">Jeffrey M. Wong</a></h4>
                    ...
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            <div class="profile-img">
                                <a href="parent-profile.php" class="avatar">M</a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="parent-profile.php">Michael S. Porch</a></h4>
                            <div class="small text-muted"></div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            <div class="profile-img">
                                <a href="parent-profile.php" class="avatar">E</a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="parent-profile.php">Elaine A. Keenum</a></h4>
                            <div class="small text-muted"></div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="parent-profile.php">Marion S. Shannon</a></h4>
                            <div class="small text-muted"></div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="parent-profile.php">Erin A. Collins</a></h4>
                            <div class="small text-muted"></div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            <div class="profile-img">
                                <a href="parent-profile.php" class="avatar">W</a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="parent-profile.php">William D. Jones</a></h4>
                            <div class="small text-muted"></div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            <div class="profile-img">
                                <a href="parent-profile.php" class="avatar">J</a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="parent-profile.php">Jennifer M. Walker</a></h4>
                            <div class="small text-muted"></div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            <div class="profile-img">
                                <a href="parent-profile.php" class="avatar">C</a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="parent-profile.php">Christopher S. Ramirez</a></h4>
                            <div class="small text-muted"></div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            <div class="profile-img">
                                <a href="parent-profile.php" class="avatar">D</a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="parent-profile.php">Danielle D. Hickson</a></h4>
                            <div class="small text-muted"></div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="parent-profile.php">Jacqueline C. Green</a></h4>
                            <div class="small text-muted"></div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">

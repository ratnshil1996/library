            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
						...
						<li>
                            <a class="active" href="exam-list.php"><i class="fa fa-table" aria-hidden="true"></i> Exam list</a>
                        </li>
                        <li>
                ...
                <div class="page-header">
					<div class="row">
						<div class="col-lg-7 col-md-12 col-sm-12 col-12">
							<h5 class="text-uppercase">exam detail</h5>
						</div>
						<div class="col-lg-5 col-md-12 col-sm-12 col-12">
							<ul class="list-inline breadcrumb float-right">
								<li class="list-inline-item"><a href="index.php">Home</a></li>
								<li class="list-inline-item"><a href="index.php">Exam list</a></li>
								<li class="list-inline-item"> Exam Detail</li>
							</ul>
						</div>
					</div>
				</div>
								...
								<div class="page-title">
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-12">
											<div class="page-title">Exam Detail</div>
										</div>
									</div>
								</div>
								<div class="card-body">	
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-12">
											 <ul class="list-group list-group-flush">
												  <li class="list-group-item list-group-item-info">
													Exam Name: Class Test
												  </li>
												  <li class="list-group-item">Subject Type : Maths</li>
												  <li class="list-group-item list-group-item-info">Class : 3</li>
												  <li class="list-group-item">Section : B</li>
												  <li class="list-group-item list-group-item-info">Date : 27/12/2018</li>
												  <li class="list-group-item">Time : 10.00 am - 11.00 am</li>
											</ul>
										</div>
									</div>
								</div>
